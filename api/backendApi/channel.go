...
type ChannelAddApiReq struct {
	...
	ListController   string `name:"list_controller" brief:"列表控制器" dc:"列表控制器"  arg:"true" v:""`
	DetailController string `name:"detail_controller" brief:"详情控制器" dc:"详情控制器"  arg:"true" v:""`
